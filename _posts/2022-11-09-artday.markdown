...
![yuck](https://b38tn1k.github.io/images/yuck.png)

Later that day...
The perlin noise art annoyed me. I had a look around [Open Game Art](https://opengameart.org/content/blowhard-2-blow-harder) and found some inspiration + more test assets. I am keeping a running attribution list [here](https://b38tn1k.github.io/november/assets/attributionList.txt).
