...
blockConfig[T_EQUAL]['accept child'] = [T_OUTLET, T_VAR, T_INPUT, T_CONST, T_COMMENT, T_ADD, T_SUBTRACT, T_MULT, T_DIV, T_MOD];
blockConfig[T_LESS]['accept child'] = [T_OUTLET, T_VAR, T_INPUT, T_CONST, T_COMMENT, T_ADD, T_SUBTRACT, T_MULT, T_DIV, T_MOD];
blockConfig[T_GREATER]['accept child'] = [T_OUTLET, T_VAR, T_INPUT, T_CONST, T_COMMENT, T_ADD, T_SUBTRACT, T_MULT, T_DIV, T_MOD];
...
blockConfig[T_COMMENT]['handles'] = {'move' : true, 'resize'  : true, 'delete'  : true, 'expand'  : false, 'mutate' : false, 'copy' : true};
