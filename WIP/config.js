...
blockConfig[T_VAR]['accept child'] = []; //nothing
blockConfig[T_INPUT]['accept child'] = []; //nothing
blockConfig[T_IF]['accept child'] = [T_CONDITION, T_DO, T_ELSE];
blockConfig[T_WHILE]['accept child'] = [T_CONDITION, T_DO, T_ELSE];
blockConfig[T_EQUAL]['accept child'] = [T_OUTLET, T_VAR, T_INPUT, T_CONST];
blockConfig[T_LESS]['accept child'] = [T_OUTLET, T_VAR, T_INPUT, T_CONST];
blockConfig[T_GREATER]['accept child'] = [T_OUTLET, T_VAR, T_INPUT, T_CONST];
blockConfig[T_ADD]['accept child'] = [T_OUTLET, T_VAR, T_INPUT, T_CONST];
blockConfig[T_SUBTRACT]['accept child'] = [T_OUTLET, T_VAR, T_INPUT, T_CONST];
blockConfig[T_MULT]['accept child'] = [T_OUTLET, T_VAR, T_INPUT, T_CONST];
blockConfig[T_DIV]['accept child'] = [T_OUTLET, T_VAR, T_INPUT, T_CONST];
blockConfig[T_MOD]['accept child'] = [T_OUTLET, T_VAR, T_INPUT, T_CONST];
blockConfig[T_GOTO]['accept child'] = [];
blockConfig[T_NOT]['accept child'] = [T_VAR, T_INPUT, T_CONST];
blockConfig[T_CONDITION]['accept child'] = [T_LESS, T_GREATER, T_NOT, T_EQUAL];
blockConfig[T_ELSE]['accept child'] = notStartOrConsole;
blockConfig[T_DO]['accept child'] = notStartOrConsole;
blockConfig[T_OUTLET]['accept child'] = [];
blockConfig[T_START]['accept child'] = notStartOrConsole;
blockConfig[T_STOP]['accept child'] = [];
blockConfig[T_ASSIGN]['accept child'] = [T_VAR, T_INPUT, T_CONST];
blockConfig[T_CONSOLE]['accept child'] = [];
blockConfig[T_PRINT]['accept child'] = [T_VAR, T_INPUT, T_CONST];
blockConfig[T_COMMENT]['accept child'] = [];
blockConfig[T_CONST]['accept child'] = [];
