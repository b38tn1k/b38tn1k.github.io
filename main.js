...
function setupPostDiv() {
  let divString = '<table width="100%"><tr><td><a href="javascript:void(0)" onclick="filterPosts(0)">All</a></td><td><a href="javascript:void(0)" onclick="filterPosts(1)">Left Brain</a></td><td> <a href="javascript:void(0)" onclick="filterPosts(2)">Right Brain</a></td></tr></table><br>';
